import { getOrganisation, getUsers } from "@/lib/database";
...
export default async function Dashboard(){
    ...
    const listUsers = dataUsers.map(user =><ul key={user.id}>Nom : {user.name}
    ...
    <ul key={organisation.id}>Nom : {organisation.name}
