const Cgu = () => {
  return (
    <div className="flex flex-col py-6 gap-6 px-6 md:px-48">
      ...
      <div className="flex flex-col gap-2 px-6 text-sm text-justify">
        <p>
          ...
          du site et des services par tripluch et de définir les conditions
        ...
        <p>
          ...
          le site. tripluch.fr se réserve le droit de modifier unilatéralement
        ...
        <p>
          Le site tripluch.fr permet à l'Utilisateur un accès gratuit aux
          services suivants :
        </p>
        ...
        <p>
          ...
          responsabilité de tripluch.fr. Dans ces cas, l’Utilisateur accepte
        ...
        <p>
          ...
          droit : par mail à l'adresse email contact@tripluch.fr
        </p>
        <h3 className="text-xl text-lightOrange my-2">
        ...
        <p>
          Les sources des informations diffusées sur le site tripluch.fr sont
        ...
        <p>
          ...
          le site tripluch.fr ne peut être tenu responsable de la modification
        ...
        <p>
          Le site tripluch.fr ne peut être tenu pour responsable d’éventuels
        ...
        <p>
          ...
          tripluch.fr. Ce dernier n’a pas de contrôle sur les pages web sur
          lesquelles aboutissent ces liens et ne saurait, en aucun cas, être
          responsable de leur contenu.
        </p>
        <h3 className="text-xl text-lightOrange my-2">ARTICLE 6 : Cookies</h3>
        <p>
        ...
        <p>
          ...
          qui sont nécessaires à l’utilisation du site tripluch.fr. Les cookies
          ne contiennent pas d’information personnelle et ne peuvent pas être
