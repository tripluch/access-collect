    ...
    return (
        <>
            <div className="flex flex-col py-6 gap-6 px-6 md:px-48 text-sm">
                <h1 className="pt-6 text-xl md:text-3xl text-oliveGreen">Politique de confidentialité</h1>
                <h2 className="italic">accescollect (https://accescollect.fr/)</h2>
                <h3 className="text-xl text-lightOrange my-2">ARTICLE 1 : Préambule</h3>
                <div className="flex flex-col gap-2 px-6 text-justify">La présente politique de confidentialité a pour but d’informer les utilisateurs du site :
                    <ul className="px-6 pl-10 list-disc">
                    ...
                    </ul>Cette politique complète les mentions légales et les Conditions Générales d’Utilisation consultables par les utilisateurs à l’adresse suivante :<a href="/politique-confidentialite">https://accescollect.fr/politique-confidentialite</a>
                </div>
                <h3 className="text-xl text-lightOrange my-2">ARTICLE 2 : Principes relatifs à la collecte et au traitement des données personnelles</h3>
                <div className="flex flex-col gap-2 px-6 text-justify">Conformément à l’article 5 du Règlement européen 2016/679, les données à caractère personnel sont :
                    <ul className="px-6 pl-10 list-disc">
                        ...
                        <li>Traitées de façon à garantir une sécurité appropriée des données collectées, y compris la protection contre le traitement non autorisé ou illicite et contre la perte, la destruction ou les dégâts d'origine accidentelle, à l'aide de mesures techniques ou organisationnelles appropriées.</li>Le traitement n'est licite que si, et dans la mesure où, au moins une des conditions suivantes est remplie :
                ...
                <h3 className="text-xl text-lightOrange my-2">ARTICLE 3 : Données à caractère personnel collectées et traitées dans le cadre de la navigation sur le site</h3>
                <div className="flex flex-col gap-2 px-6 text-justify">
                    <p> Article 3.1 : Données collectées</p>
                    <p>Les données personnelles collectées dans le cadre de notre activité sont les suivantes : Nom, Prénom, type d’utilisateur et adresse e-mail. La collecte et le traitement de ces données répond à la (aux) finalité(s) suivante(s) : Personnalisation de compte et contact via e-mail.</p>
                    <p> Article 3.2 : Mode de collecte des données</p>
                    <p>Lorsque vous utilisez notre site, sont automatiquement collectées les données suivantes : Des données analytiques via Google Analytics. Les données sont anonymes.</p>
                    <p> D’autres données personnelles sont collectées lorsque vous effectuez les opérations suivantes sur la plateforme : Nom, Prénom, type d’utilisateur et adresse e-mail à l’inscription de l’utilisateur. Localisation, si autorisation par l'utilisateur, lors de l'ouverture de la carte. La localisation n'est pas stockée.  Un token (clé) à la connexion de l'utilisateur pour faire vivre la session.</p>
                    <p> Elles sont conservées par le responsable du traitement dans des conditions raisonnables de sécurité, pour une durée de : tant que l’utilisateur est actif, les données sont conservées. Dans le cas contraire, nous limitons à 5 ans la période à compter de la dernière activité. La société est susceptible de conserver certaines données à caractère personnel au-delà des délais annoncés ci-dessus afin de remplir ses obligations légales ou réglementaires.</p>
                    <p>Article 3.3 : Hébergement des données</p><p>Le site tripluch est hébergé par : Vercel Inc – 340 S Lemon Ave #4133 - Walnut, CA 91789</p>
                    <p>Aucune donnée n’est transmise à un tier.</p>
                    <p>Aucun cookie n’est utilisé/collecté.</p>
                </div>
                <h3 className="text-xl text-lightOrange my-2">ARTICLE 4 : Responsable du traitement des données et délégué à la protection des données </h3>
                <div className="flex flex-col gap-2 px-6 text-justify">
                    <p>Article 4.1 : Le responsable du traitement des données : </p>
                    <p>Les données à caractère personnelles sont collectées par tripluch, 205 place de la liberté 83000 Toulon, Société Anonyme, dont le numéro d’immatriculation est le 949 820 013 (00017). Le responsable du traitement des données à caractère personnel peut être contacté de la manière suivante : Par mail : contact@tripluch.fr</p>
                    <p> Article 4.2 : Le délégué à la protection des données</p>
                    <p>Le délégué à la protection des données de l’entreprise ou du responsable est : Maud Tribaudeau maud.tribaudeau@tripluch.fr.</p>
                ...
                <h3 className="text-xl text-lightOrange my-2">ARTICLE 5 : Les droits de l'utilisateur en matière de collecte et traitement des données </h3>
                <div className="flex flex-col gap-2 px-6 text-justify">Tout utilisateur concerné par le traitement de ses données personnelles peut se prévaloir des droits suivants, en application du règlement européen 2016/679 et de la Loi Informatique et Liberté (Loi 78-17 du 6 janvier 1978) :
                    <ul className="px-6 pl-10 list-disc">
                        ...
                        <li>Droit à la portabilité des données (article 20 du RGPD) ;</li><li>Droit à la limitation (article 18 du RGPD) et à l’opposition du traitement des données (article 21 du RGPD) ;</li>
                    ...
                    Pour exercer vos droits, veuillez adresser votre courrier par mail à contact@tripluch.fr. Afin que le responsable du traitement des données puisse faire droit à sa demande, l’utilisateur peut être tenu de lui communiquer certaines informations telles que : ses noms et prénoms, son adresse e-mail ainsi que son numéro de compte, d’espace personnel ou d’abonné. Consultez le site cnil.fr pour plus d’informations sur vos droits.
                </div>
                <h3 className="text-xl text-lightOrange my-2">ARTICLE 6 : Conditions de modification de la politique de confidentialité</h3>
                <div className="flex flex-col gap-2 px-6 text-justify mb-6">L’éditeur du site tripluch se réserve le droit de pouvoir modifier la présente Politique à tout moment afin d’assurer aux utilisateurs du site sa conformité avec le droit en vigueur. Les éventuelles modifications ne sauraient avoir d’incidence sur les achats antérieurement effectués sur le site, lesquels restent soumis à la Politique en vigueur au moment de l’achat et telle qu’acceptée par l’utilisateur lors de la validation de l’achat. L’utilisateur est invité à prendre connaissance de cette Politique à chaque fois qu’il utilise nos services, sans qu’il soit nécessaire de l’en prévenir formellement. La présente politique, éditée le 15/10/2022, a été mise à jour le 18/03/2023.
                </div>
            </div>
        </>
    )
