      ...
      <div className="flex flex-col py-6 gap-6 px-6 md:px-48 text-sm">
        ...
        <div className="flex flex-col gap-2 px-6 text-justify">
          ...
          <a href="/politique-confidentialite">
            https://accescollect.fr/politique-confidentialite
          </a>
        </div>
        <h3 className="text-xl text-lightOrange my-2">
        ...
        <div className="flex flex-col gap-2 px-6 text-justify">
          ...
          <p>
            ...
            sont les suivantes : Nom, Prénom, type d’utilisateur et adresse
            e-mail. La collecte et le traitement de ces données répond à la
            (aux) finalité(s) suivante(s) : Personnalisation de compte et
            contact via e-mail.
          </p>
          <p> Article 3.2 : Mode de collecte des données</p>
          <p>
            Lorsque vous utilisez notre site, sont automatiquement collectées
            les données suivantes : Des données analytiques via Google
            Analytics. Les données sont anonymes.
          </p>
          <p>
            {" "}
            D’autres données personnelles sont collectées lorsque vous effectuez
            les opérations suivantes sur la plateforme : Nom, Prénom, type
            d’utilisateur et adresse e-mail à l’inscription de l’utilisateur.
            Localisation, si autorisation par l'utilisateur, lors de l'ouverture
            de la carte. La localisation n'est pas stockée. Un token (clé) à la
            connexion de l'utilisateur pour faire vivre la session.
          </p>
          <p>
            {" "}
            Elles sont conservées par le responsable du traitement dans des
            conditions raisonnables de sécurité, pour une durée de : tant que
            l’utilisateur est actif, les données sont conservées. Dans le cas
            contraire, nous limitons à 5 ans la période à compter de la dernière
            activité. La société est susceptible de conserver certaines données
            à caractère personnel au-delà des délais annoncés ci-dessus afin de
            remplir ses obligations légales ou réglementaires.
          </p>
          <p>Article 3.3 : Hébergement des données</p>
          <p>
            Le site tripluch est hébergé par : Vercel Inc – 340 S Lemon Ave
            #4133 - Walnut, CA 91789
          </p>
        ...
        <div className="flex flex-col gap-2 px-6 text-justify">
          ...
          <p>
            Les données à caractère personnelles sont collectées par tripluch,
            205 place de la liberté 83000 Toulon, Société Anonyme, dont le
            numéro d’immatriculation est le 949 820 013 (00017). Le responsable
            du traitement des données à caractère personnel peut être contacté
            de la manière suivante : Par mail : contact@tripluch.fr
          </p>
          <p> Article 4.2 : Le délégué à la protection des données</p>
          <p>
            Le délégué à la protection des données de l’entreprise ou du
            responsable est : Maud Tribaudeau maud.tribaudeau@tripluch.fr.
          </p>
        ...
        <h3 className="text-xl text-lightOrange my-2">
          ARTICLE 5 : Les droits de l'utilisateur en matière de collecte et
        ...
        <div className="flex flex-col gap-2 px-6 text-justify">
          ...
          Pour exercer vos droits, veuillez adresser votre courrier par mail à
          contact@tripluch.fr. Afin que le responsable du traitement des données
          puisse faire droit à sa demande, l’utilisateur peut être tenu de lui
          communiquer certaines informations telles que : ses noms et prénoms,
          son adresse e-mail ainsi que son numéro de compte, d’espace personnel
          ou d’abonné. Consultez le site cnil.fr pour plus d’informations sur
          vos droits.
        </div>
        <h3 className="text-xl text-lightOrange my-2">
        ...
        <div className="flex flex-col gap-2 px-6 text-justify mb-6">
          L’éditeur du site tripluch se réserve le droit de pouvoir modifier la
          ...
          formellement. La présente politique, éditée le 15/10/2022, a été mise
          à jour le 18/03/2023.
        </div>
      </div>
    </>
  );
